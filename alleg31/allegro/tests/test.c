...
void triangle3d_demo()
{
   ...
   while (!next()) {
      ...
      v1.z = itofix((random() & 127) + 40);
      v2.z = itofix((random() & 127) + 40);
      v3.z = itofix((random() & 127) + 40);
...
MENU mmx_menu[] =
{
   { "&Autodetect",              mmx_auto_proc,    NULL,    D_SELECTED  },
   { "&Disable 3DNow",           mmx_3doff_proc,   NULL,    0,          },
   { "&Disable MMX",             mmx_off_proc,     NULL,    0           },
   { NULL,                       NULL,             NULL,    0           }
};
...
MENU test_menu[] =
{
   ...
   { "MM&X mode",                NULL,             mmx_menu },
   { "",                         NULL,             NULL },
   { "&Profile Screen",          profile_proc,     NULL },
   { "Profile &Memory",          mem_profile_proc, NULL },
   { "Profile &3D",              p3d_profile_proc, NULL },
   { "",                         NULL,             NULL },
   { "&Quit",                    quit_proc,        NULL },
   { NULL,                       NULL,             NULL }
};
...
MENU primitives_menu[] =
{
   ...
   { "triangle&3d()",            triangle3d_proc,  NULL },
   { NULL,                       NULL,             NULL }
};
...
MENU misc_menu[] =
{
   ...
   { "&Accelerated features",    caps_proc,        NULL },
   { NULL,                       NULL,             NULL }
};
...
DIALOG title_screen[] =
{
   ...
   { d_ctext_proc,      0,    128,  0,    0,    255,  0,    0,    0,       0,    0,    gfx_specs3 },
   { d_ctext_proc,      0,    160,  0,    0,    255,  0,    0,    0,       0,    0,    mouse_specs },
   { d_ctext_proc,      0,    192,  0,    0,    255,  0,    0,    0,       0,    0,    cpu_specs },
