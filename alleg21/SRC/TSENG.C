...
static GFX_MODE_INFO et3000_mode_list[] =
{
   {  640,  350,  0x2D,  0  },
   {  640,  480,  0x2E,  0  },
   {  800,  600,  0x30,  0  },
...
static GFX_MODE_INFO et4000_mode_list[] =
{
   {  640,  350,  0x2D,  0  },
   {  640,  480,  0x2E,  0  },
   {  640,  400,  0x2F,  0  },
...
static BITMAP *et3000_init(int w, int h, int v_w, int v_h)
{
   ...
   b = _gfx_mode_set_helper(w, h, v_w, v_h, &gfx_et3000, et3000_detect, et3000_mode_list, NULL);
   if (!b)
      return NULL;
...
static BITMAP *et4000_init(int w, int h, int v_w, int v_h)
{
   ...
   b = _gfx_mode_set_helper(w, h, v_w, v_h, &gfx_et4000, et4000_detect, et4000_mode_list, NULL);
   if (!b)
      return NULL;
