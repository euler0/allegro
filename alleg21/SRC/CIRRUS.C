...
static GFX_MODE_INFO cirrus_64_mode_list[] =
{
   {  640,  400,  0x2D,  0  },
   {  640,  480,  0x2E,  0  },
   {  800,  600,  0x30,  0  },
...
static GFX_MODE_INFO cirrus_54_mode_list[] =
{
   {  640,  480,  0x5F,  0  },
   {  800,  600,  0x5C,  0  },
   {  1024, 768,  0x60,  0  },
...
static BITMAP *cirrus_64_init(int w, int h, int v_w, int v_h)
{
   ...
   b = _gfx_mode_set_helper(w, h, v_w, v_h, &gfx_cirrus64, cirrus_64_detect, cirrus_64_mode_list, NULL);
   if (!b)
      return NULL;
...
static BITMAP *cirrus_54_init(int w, int h, int v_w, int v_h)
{
   ...
   b = _gfx_mode_set_helper(w, h, v_w, v_h, &gfx_cirrus54, cirrus_54_detect, cirrus_54_mode_list, NULL);
   if (!b)
      return NULL;
