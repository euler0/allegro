 ...
 *      England, TF9 1AJ.
 *
 *      Interrupt wrapper functions. Unlike the _go32_dpmi_* functions,
 *      these can deal with reentrant interrupts.
 *
...
#define STACK_SIZE   8*1024      /* how much stack do we really need? */
