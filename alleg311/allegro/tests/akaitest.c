...
DIALOG record_dialog[] =
{
   ...
   { d_shadow_box_proc, 160,  120,  320,  264,  255,  0,    0,       0,          0,             0,       NULL },
   { d_ctext_proc,      320,  136,  0,    0,    255,  0,    0,       0,          0,             0,       "Record Sample" },
   { d_button_proc,     208,  336,  96,   24,   255,  0,    13,      D_EXIT,     0,             0,       "OK" },
   { d_button_proc,     338,  336,  96,   24,   255,  0,    27,      D_EXIT,     0,             0,       "Cancel" },
   { d_text_proc,       208,  176,  0,    0,    255,  0,    0,       0,          0,             0,       "Length:" },
   { d_edit_proc,       277,  176,  64,   8,    255,  0,    0,       0,          15,            0,       record_length },
   { d_text_proc,       208,  200,  0,    0,    255,  0,    0,       0,          0,             0,       "Freq:" },
   { d_edit_proc,       277,  200,  64,   8,    255,  0,    0,       0,          15,            0,       record_freq },
   { d_text_proc,       208,  224,  0,    0,    255,  0,    0,       0,          0,             0,       "16 bit:" },
   { d_check_proc,      272,  221,  16,   12,   255,  0,    0,       0,          0,             0,       "" },
   { d_text_proc,       208,  248,  0,    0,    255,  0,    0,       0,          0,             0,       "Stereo:" },
   { d_check_proc,      272,  245,  16,   12,   255,  0,    0,       0,          0,             0,       "" },
   { d_radio_proc,      368,  176,  48,   12,   255,  0,    0,       D_SELECTED, 1,             0,       "Mic" },
   { d_radio_proc,      368,  200,  48,   12,   255,  0,    0,       0,          1,             0,       "Line" },
   { d_radio_proc,      368,  224,  48,   12,   255,  0,    0,       0,          1,             0,       "CD" },
   { waveform_proc,     208,  280,  226,  32,   1,    0,    0,       0,          0,             0,       NULL },
   { NULL }
};
...
DIALOG the_dialog[] =
{
   ...
   { d_ctext_proc,      320,  4,    0,    0,    255,  8,    0,       0,          0,             0,       "Audio input test program for Allegro " ALLEGRO_VERSION_STR },
   { d_ctext_proc,      320,  20,   0,    0,    255,  8,    0,       0,          0,             0,       "By Shawn Hargreaves, " ALLEGRO_DATE_STR },
   { d_text_proc,       224,  88,   0,    0,    255,  8,    0,       0,          0,             0,       "MIDI Input:" },
   { d_text_proc,       328,  88,   0,    0,    255,  8,    0,       0,          0,             0,       NULL },
   { d_text_proc,       216,  112,  0,    0,    255,  8,    0,       0,          0,             0,       "Audio Input:" },
   { d_text_proc,       328,  112,  0,    0,    255,  8,    0,       0,          0,             0,       NULL },
   { d_text_proc,       208,  136,  0,    0,    255,  8,    0,       0,          0,             0,       "Audio Output:" },
   { d_text_proc,       328,  136,  0,    0,    255,  8,    0,       0,          0,             0,       NULL },
   { load_proc,         160,  232,  128,  24,   255,  0,    0,       D_EXIT,     0,             0,       "Load Sample" },
   { record_proc,       352,  232,  128,  24,   255,  0,    0,       D_EXIT,     0,             0,       "Record Sample" },
   { d_button_proc,     256,  320,  128,  24,   255,  0,    0,       D_EXIT,     0,             0,       "Quit" },
   { piano_proc,        2,    440,  636,  40,   255,  0,    0,       0,          0,             0,       NULL },
   { NULL }
};
