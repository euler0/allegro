...
{
   { "Normal",                      editor,           NULL },
   { "Capslock",                    editor,           NULL },
   { "Shifted",                     editor,           NULL },
   { "Control",                     editor,           NULL },
   { "Alt-GR",                      editor,           NULL },
   { "Accent1",                     editor,           NULL },
   { "Accent1 (caps)",              editor,           NULL },
   { "Accent1+shift",               editor,           NULL },
   { "Accent1+shift (caps)",        editor,           NULL },
   { "Accent2",                     editor,           NULL },
   { "Accent2 (caps)",              editor,           NULL },
   { "Accent2+shift",               editor,           NULL },
   { "Accent2+shift (caps)",        editor,           NULL },
   { NULL,                          NULL,             NULL }
};
...
DIALOG main_dlg[] =
{
   ...
   { d_ctext_proc,      160,  80,   0,    0,    255,  0,    0,       0,          0,             0,       "Allegro Keyboard Setup Utility" },
   { d_ctext_proc,      160,  100,  0,    0,    255,  0,    0,       0,          0,             0,       "Version " ALLEGRO_VERSION_STR },
   { d_ctext_proc,      160,  132,  0,    0,    255,  0,    0,       0,          0,             0,       "By Shawn Hargreaves, " ALLEGRO_DATE_STR },
   { d_text_proc,       80,   200,  0,    0,    255,  0,    0,       0,          0,             0,       "Name:" },
   { d_edit_proc,       128,  200,  192,  8,    255,  0,    0,       0,          23,            0,       keyboard_name },
