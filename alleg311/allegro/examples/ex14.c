...
DIALOG the_dialog[] =
{
   ...
   { d_edit_proc,       32,   32,   256,  8,    255,  0,    0,    0,       sizeof(the_string)-1, 0, the_string },
   { d_check_proc,      32,   64,   88,   12,   255,  0,    't',  0,       0,    0,    "&Toggle Me" },
   { clock_proc,        192,  64,   64,   64,   255,  0,    0,    0,       0,    0,    NULL },
   { d_button_proc,     120,  160,  80,   16,   255,  0,    0,    D_EXIT,  0,    0,    "Exit" },
