...
{
   unsigned char msg[2] = { 0xC0+channel, prog };
   midi_out(msg, 2);
}
...
{
   unsigned char msg[3] = { 0xB0+channel, 10, pan };
   midi_out(msg, 3);
}
...
{
   unsigned char msg[3] = { 0x90+channel, pitch, vel };
   midi_out(msg, 3);
}
...
{
   unsigned char msg[3] = { 0x80+channel, pitch, 0 };
   midi_out(msg, 3);
}
...
DIALOG thedialog[] =
{
   ...
   { d_ctext_proc,      320,  4,    0,    0,    255,  8,    0,       0,          0,             0,       "MIDI test program for Allegro " ALLEGRO_VERSION_STR },
   { d_ctext_proc,      320,  20,   0,    0,    255,  8,    0,       0,          0,             0,       "By Shawn Hargreaves, " ALLEGRO_DATE_STR },
   { d_text_proc,       320,  128,  0,    0,    255,  8,    0,       0,          0,             0,       "Driver:" },
   { d_text_proc,       352,  152,  0,    0,    255,  8,    0,       0,          0,             0,       NULL },
   { d_text_proc,       320,  192,  0,    0,    255,  8,    0,       0,          0,             0,       "Description:" },
   { d_text_proc,       352,  216,  0,    0,    255,  8,    0,       0,          0,             0,       NULL },
   { instlist_proc,     16,   56,   256,  355,  255,  0,    32,      D_EXIT,     0,             0,       instlist_getter },
   { piano_proc,        2,    440,  636,  40,   255,  0,    0,       0,          0,             0,       NULL },
   { d_text_proc,       320,  320,  0,    0,    255,  8,    0,       0,          0,             0,       "Volume:" },
   { d_edit_proc,       392,  320,  64,   16,   255,  8,    0,       0,          3,             3,       "127\0" },
   { d_text_proc,       320,  352,  0,    0,    255,  8,    0,       0,          0,             0,       "Pan:" },
   { d_edit_proc,       392,  352,  64,   16,   255,  8,    0,       0,          3,             2,       "63\0\0" },
   { NULL }
};
